...
import (
	...
	structures "P1_202200252/structures" // Importa el paquete "structures" desde el directorio "EDD2021/structures"
	utils "P1_202200252/utils"           // Importa el paquete "utils" desde el directorio "EDD2021/utils"
...
func ParserMkdisk(tokens []string) (string, error) {
	...
	for _, match := range matches {
		...
		case "-unit":
			...
			if value != "K" && value != "M" && value != "k" && value != "m" {
